...
```{r mapa-europa,echo=TRUE, message=FALSE, warning=FALSE}
...
```{r grafico-tendencia-metales,echo=TRUE, fig.width=10, fig.height=5}
...
```{r plot-correlaciones, echo=TRUE, fig.width=10}
# 1. Separar los datos
...
```{r grafico-relacion-alzheimer-Plomo,echo=TRUE, fig.width=9, fig.height=6}
...
# Ajustamos el tamaño de la figura
````{r grafico-relacion-alzheimer-Mercurio,echo=TRUE, fig.width=9, fig.height=6}
...
```{r genes-interactuan-metales, echo=TRUE, message = FALSE, warning = FALSE, fig.width= 9, fig.height=6}  
...
```{r genes-nocivos-alzheimer, echo=TRUE, message = FALSE, warning = FALSE, fig.width= 9, fig.height=6}
...
```{r genes-interaccion-alzheimer-, echo=TRUE, message = FALSE, warning = FALSE, fig.width= 9, fig.height=6}
...
Vamos a ver esto mediante un gráfico de dispersión con línea de regresión, separado en dos gráficos (uno para Hg y otro para Pb). Cada gráfico mostrará el número de muertes en el eje Y y el nivel del metal en el eje X.
```{r plot-correlaciones2, echo=TRUE, fig.width=10}
...
```{r grafico-relacion-Parkinson-Plomo,echo=TRUE, fig.width=9, fig.height=6}
...
```{r grafico-relacion-Parkinson-Mercurio,echo=TRUE, fig.width=9, fig.height=6}
# Usamos df2 para Parkinson
...
```{r grafico_barras_pbhg_parkinson_final, echo=TRUE, message=FALSE, warning=FALSE, fig.width=9, fig.height=6, results='hide'}
...
```{r genes-nocivos-parkinson, echo=TRUE, message = FALSE, warning = FALSE, fig.width=9, fig.height=6}
...
```{r genes-interaccion-parkinson,echo=TRUE, fig.width=9, fig.height=6}
